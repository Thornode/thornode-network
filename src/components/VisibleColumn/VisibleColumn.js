...
function VisibleColumn({ initialConfig, onConfigUpdate }) {
  ...
  const {
    ...
    error: locationError,
  } = useApiData("https://api.liquify.com/thor/api/locations");

  const {
    data: versionData,
    loading: versionLoading,
    error: versionError,
  } = useApiData("https://api.liquify.com/thor/api/versions");
  ...
  return (
    <div>
      ...
      >
        <CustomPieChart data={locationPieChartData} options={chartOptions} />
      </Modal>
      ...
      >
        <CustomPieChart data={versionPieChartData} options={chartOptions} />
      </Modal>
    </div>
  );
}
